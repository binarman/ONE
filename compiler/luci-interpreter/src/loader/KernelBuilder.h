...
public:
  ...
  std::unique_ptr<Kernel> visit(const luci::CircleExpandDims *node);
  std::unique_ptr<Kernel> visit(const luci::CircleFill *node) override;
  ...
  std::unique_ptr<Kernel> visit(const luci::CircleGather *node) override;
  ...
  std::unique_ptr<Kernel> visit(const luci::CircleRange *node) override;
  std::unique_ptr<Kernel> visit(const luci::CircleRank *node) override;
